...
class MLflowLogger:
    ...
    def log_backtest_results(
        self, backtest_metrics: dict[str, float], strategy_name: str, period: str
    ) -> str | None:
        """
    ...
    def log_risk_model_metrics(
        self, model_metrics: dict[str, float], model_type: str
    ) -> str | None:
        """
...
def log_optimization_run(
    ...
    """
    logger = get_logger()
    return logger.log_optimization_run(
        metrics, portfolio, optimization_type, parameters
    )


def log_backtest_results(
    backtest_metrics: dict[str, float], strategy_name: str, period: str
) -> str | None:
    """
...
if __name__ == "__main__":
    ...
    test_portfolio = {"AAPL": 0.15, "GOOGL": 0.12, "MSFT": 0.18, "CASH": 0.55}
