...
def create_architecture_diagram():
    ...
    with dot.subgraph(name="cluster_engine") as engine:
        engine.attr(
            label="Portfolio Optimization Engine", style="filled", color="lightgray"
        )
...
def create_data_flow_diagram():
    ...
    dot = graphviz.Digraph("data_flow", comment="Data Flow Diagram", format="png")
...
def main():
    ...
    try:
        ...
        arch_diagram.render(str(output_dir / "architecture"), cleanup=True)
        print(f"✅ Architecture diagram saved to {output_dir / 'architecture.png'}")

        # Generate data flow diagram
        flow_diagram = create_data_flow_diagram()
        flow_diagram.render(str(output_dir / "data_flow"), cleanup=True)
