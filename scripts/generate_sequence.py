...
def create_optimization_sequence():
    ...
    dot = graphviz.Digraph(
        "optimization_sequence", comment="Portfolio Optimization Sequence", format="png"
    )
    ...
    # Add sequence arrows
    for _i, (src, dst, label) in enumerate(steps):
...
def create_rag_sequence():
    ...
    dot = graphviz.Digraph("rag_sequence", comment="RAG Query Sequence", format="png")
...
def create_risk_management_sequence():
    ...
    dot = graphviz.Digraph(
        "risk_management_sequence", comment="Risk Management Sequence", format="png"
    )
...
def main():
    ...
    try:
        ...
        opt_diagram.render(str(output_dir / "sequence_optimization"), cleanup=True)
        print(
            f"✅ Optimization sequence saved to {output_dir / 'sequence_optimization.png'}"
        )

        # Generate RAG sequence
        rag_diagram = create_rag_sequence()
        rag_diagram.render(str(output_dir / "sequence_rag"), cleanup=True)
        ...
        pipeline_diagram.render(
            str(output_dir / "sequence_feature_pipeline"), cleanup=True
        )
        print(
            f"✅ Feature pipeline sequence saved to {output_dir / 'sequence_feature_pipeline.png'}"
        )

        # Generate risk management sequence
        risk_diagram = create_risk_management_sequence()
        risk_diagram.render(str(output_dir / "sequence_risk_management"), cleanup=True)
        print(
            f"✅ Risk management sequence saved to {output_dir / 'sequence_risk_management.png'}"
        )
